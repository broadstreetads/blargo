...
class Blargo_Zone_Widget extends WP_Widget
{
     ...
     */
     function __construct()
     {
        ...
        $this->WP_Widget('blargo_zone', 'Ad Zone', $widget_ops);
     }
 ...
 * This is an optional widget to display a broadstreet zone
 */
class Blargo_Category_Keyword_Zone_Widget extends WP_Widget
{
    /**
     * Set the widget options
     */
     function __construct()
     {
        $widget_ops = array('classname' => 'bs_zones', 'description' => 'Easily place an ad zone with this widget. Includes keywords based on category name, page name, and others instead of URL.');
        $this->WP_Widget('blargo_keyword_zone', 'Ad Zone (Dynamic Keywords)', $widget_ops);
     }
     ...
     function widget($args, $instance)
     {
        ...
        $slugs = blargo_get_category_slugs();
...
register_widget('Blargo_Category_Keyword_Zone_Widget');