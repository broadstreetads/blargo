...
function optionsframework_options() {
    ...
    $blargopath=  get_stylesheet_directory_uri().'/assets/img/';
	...
	$options[] = array(
		...
		'options' 	=> array(
            ...
            '2col_rev' => $blargopath . '2col-rev.png'
            // Disabled for Broadstreet
	...
	$font_options = array(
		'largo' 	=> __('Largo Style (Default)', 'largo'),
		'helvetica' => __('Helvetica', 'largo'),
	);
    
	$options[] = array(
		'name' 	=> __('Broadstreet Add-Ons', 'largo'),
		'type' 	=> 'heading');

	$options[] = array(
        'name' 	=> __('Layout Options', 'largo'),
		'desc' 	=> __('<strong>Fixed Width:</strong> Use fixed-width 960px layout for large screens instead of full screen', 'largo'),
		'id' 	=> 'fixed_layout',
		'std' 	=> '1',
		'type' 	=> 'checkbox');
    
	$options[] = array(
		'desc' 	=> __('<strong>Tight Margins:</strong> Don\'t leave any padding between the navigation bar and the edge of the content background.', 'largo'),
		'id' 	=> 'no_margins',
		'std' 	=> '1',
		'type' 	=> 'checkbox');
    
	$options[] = array(
		'desc' 	=> __('<strong>Monster Ad Spot:</strong> Show the "monster" ad spot at the very top of the page, which is 960px wide in the fixed layout above.', 'largo'),
		'id' 	=> 'monster_ad',
		'std' 	=> '0',
		'type' 	=> 'checkbox');
    
	$options[] = array(
		'name' 	=> __('Background Settings', 'largo'),
		'desc' 	=> __('<strong>Image:</strong> This is an image used for the page background. For local news publishers, it\'s fun to have a scene from around town.', 'largo'),
		'id' 	=> 'page_background',
		'type' 	=> 'upload');
    
	$options[] = array(
		'desc' 	=> __('<strong>Background Transparency (0 - 100):</strong> Set this to control the transparency of the content background. This will create a nice effect when you use a page background image above.', 'largo'),
		'id' 	=> 'bg_transparency',
		'std' 	=> '100',
		'type' 	=> 'text');
	...
	$options[] = array(
        'name'      => 'Color Scheme',
		'desc' 		=> __('What would you like your color scheme to be?', 'largo'),
		'id' 		=> 'color_scheme',
		'std' 		=> 'blue',
		'type'		=> 'select',
		//'class'		=> 'mini',
